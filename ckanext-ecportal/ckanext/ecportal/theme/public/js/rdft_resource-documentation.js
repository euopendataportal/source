...
$(function () {
    ...
    function create_resource_list_item(res_number) {
        var new_resource_list_item = $(".templates_documentation>.resource_list_documentation_item_template").clone();
        new_resource_list_item.attr('id', 'resource-list_documentation-item-' + res_number);
    ...
    function add_resource_documentation(activeResource){
        ...
        var resource_list = $('#resource-list-documentation');
        var new_resource_details = initialize_documentation_resource_details(res_number);
    ...
    function initialize_documentation_resource_details(res_number) {
        var default_lang = 'en';
        var new_resource_details = $(".templates_documentation>.resource-details_documentation-template").clone();
        new_resource_details.attr("id", "resource_details_documentation_"+ res_number);
        ...
        var title_tag = new_resource_details.find("[name='resources_documentation__"+res_number+"__title']");
        // TODO : fix this, #resource-list-item not correct anymore
        title_tag.keyup(function (event) {
            if (title_tag.val() != '') {
                $("#resource-list_documentation-item-" + res_number).find('em').text(title_tag.val());
            } else {
                $("#resource-list_documentation-item-" + res_number).find('em').text('[new resource]');
            }
        });
        var format_tag = new_resource_details.find("#resources_documentation__"+res_number+"__format");
        format_tag.append($('.templates_documentation #resource_dropdown_format_template').clone().children());

        var language_tag = new_resource_details.find("#resources_documentation__"+res_number+"__language");
    ...
    $('a.js-resource-add').click(function (event) {
        ...
        if(type=="documentation"){
            ...
            var new_resource_details = add_resource_documentation($(this).data('type'));
    ...
    $(document).on('click', '.resource-lang', function () {
        ...
        if(type=='documentation'){
            ...
            add_translations_inputs(new_lang, "resources_documentation__" + resNumber + "__title", "js-resource-edit-title-field translatable-resource-field", "", "", widgetInput);
            add_translations_inputs(new_lang, "resources_documentation__" + resNumber + "__description", "js-resource-edit-description markdown-input translatable-resource-field", "", "", widgetTextarea);
            add_translations_inputs(new_lang, "resources_documentation__" + resNumber + "__url", "js-resource-edit-url long translatable-resource-field", "", "", widgetInput);
