...
// Created: 7/12/2016 2:20:21 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsora5b210000wcbakdk679j_6i2x";
	this.domain="data.europa.eu/euodp";
	this.timezone=1;
	this.onsitedoms="";
	this.downloadtypes="xls,doc,ppt,pdf,odt,txt,csv,zip,docx,xlsx,pptx,jpeg,jpg,wmv,avi,mpg,mp4,mp3,wav,wma";
