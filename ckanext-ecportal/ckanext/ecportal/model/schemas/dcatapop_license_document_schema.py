...
class LicenseDocumentDcatApOp(SchemaGeneric):
    def __init__(self, uri=None, graph_name=DCATAPOP_PUBLIC_GRAPH_NAME):
        super(LicenseDocumentDcatApOp, self).__init__(uri, graph_name)
        self.type_rdf['0'] = SchemaGeneric(NAMESPACE_DCATAPOP.dcterms + "LicenseDocument", graph_name)
