...
class CategorySchemeSchemaDcatApOp(SchemaGeneric):
    def __init__(self, uri=None, graph_name=DCATAPOP_PUBLIC_GRAPH_NAME):
        super(CategorySchemeSchemaDcatApOp, self).__init__(uri, graph_name)
        self.title_dcterms = {}  # type: dict[str,ResourceValue]
        self.type_rdf['0'] = SchemaGeneric(NAMESPACE_DCATAPOP.skos + "ConceptScheme", graph_name)
