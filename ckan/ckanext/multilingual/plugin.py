...
def translate_data_dict(data_dict):
    ...
    for (key, value) in flattened.items():
        ...
        # Don't translate eurovoc concept names
        # In this case the key is a 3-element tuple like ('concepts_eurovoc', 0 'name')
        elif 'concepts_eurovoc' in key and 'name' in key:
            translated_flattened[key] = value
