...
class UserController(base.BaseController):
    ...
    def me(self, locale=None):
        ...
        h.redirect_to(locale=locale, controller='user', action='dashboard_datasets', id=user_ref)
        ...
        if not c.user:
           ...
           # if not came_from:
            ...
            came_from = h.url_for(controller='user', action='logged_in')
                # did this change for /euodp path
    ...
    def dashboard_datasets(self):
        context = {'for_view': True, 'user': c.user or c.author,
                   'auth_user_obj': c.userobj, 'no_groups':True}
    ...
    def dashboard_organizations(self):
        context = {'for_view': True, 'user': c.user or c.author,
                   'auth_user_obj': c.userobj, 'return_minimal':True}
        data_dict = {'user_obj': c.userobj}
        self._setup_template_variables(context, data_dict)
