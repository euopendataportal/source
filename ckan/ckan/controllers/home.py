...
class HomeController(base.BaseController):
    ...
    def index(self):
        try:
            ...
            c.organizations = logic.get_action('organization_list')(context, data_dict)
            c.contextTest = context
            c.data_dictTest = data_dict
        ...
        if not dirty_cached_group_stuff:
            ...
            for group in groups_data:
                if group['group_dict'].get('packages', None):
